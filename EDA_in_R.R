...
library(ggplot2)
################################################################################
# 0. Be sure you are working in the correct folder, getwd() and to change it setwd("Path")
# To know what a function does you do ??function_name
################################################################################
...
getwddf_og <- read.csv('/Users/matiasborrell/brushup_files/data/WB_more_data.csv')
